          ...
          <form onSubmit={submit} className="mt">
            ...
            <div className="legal-consents">
              ...
              <label className="lc-row">
                ...
                <span>He leído la <Link to="/privacy" target="_blank">Política de Privacidad</Link> (conservación 10 años SEPRELAD).</span>
              </label>
              <label className="lc-row">
                <input type="checkbox" checked={form.accept_kyc} onChange={e => up('accept_kyc', e.target.checked)} />
                <span>Consiento expresamente el procedimiento KYC/AML conforme a normativa SEPRELAD.</span>
              </label>
            </div>
